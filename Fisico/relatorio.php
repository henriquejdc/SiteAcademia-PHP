    ...
    <section id="about" class="container content-section text-center">
        <div class="row">
                ...
                <form action=".php" method="post">
                    <div class="red">    
                        <label> Total pago no mês</label><br><br>
                        <input type="submit" value="Relatorio"><br><br>
                    </div> 
                </form> 
                <form action=".php" method="post">
                    <div class="red">    
                        <label> Relatorio por Gênero</label><br>
                        <br>
                        <select name="Genero">
                          <option value="Homem">Homem</option>
                          <option value="Mulher">Mulher</option>
                        </select>
                       <br><br><input type="submit" value="Relatorio"><br><br>
                    </div> 
                </form> 
                <form action=".php" method="post">
                    <div class="red">    
                         <div class="red">    
                             <label> Atrasados</label><br><br>
                             <input type="submit" value="Relatorio"><br><br>
                         </div> 
                    </div> 
                </form> 
